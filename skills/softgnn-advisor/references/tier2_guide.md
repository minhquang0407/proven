# SoftGNN Tier 2 Intelligence Guide: HGT Blast Radius & Triage

This reference guide provides in-depth technical details on SoftGNN's **Tier 2 (Graph AI Core)** capabilities for Coding Agents.
...
### Invocation:
```bash
python skills/softgnn-advisor/scripts/query_impact.py \
...
### Invocation:
```bash
python skills/softgnn-advisor/scripts/triage_expert.py \
...
### Prerequisites:
Requires PyTorch Geometric installed (`pip install softgnn-advisor[gnn]`).
