...
SoftGNN Advisor's **Universal Engine (Track 2)** uses standard **LCOV (`lcov.info`)** or Go **coverprofile (`coverage.out`)** reports to verify Runtime Proof Gates across any programming language.
...
Or let SoftGNN execute the command and verify in one step:
