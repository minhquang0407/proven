# Proven — Standalone Scripts API Reference

This reference documents the CLI interface and JSON output schemas for all standalone scripts in `skills/proven/scripts/`.
