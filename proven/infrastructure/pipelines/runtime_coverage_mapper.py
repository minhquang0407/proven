...
from proven.core.metadata_utils import load_metadata, save_metadata, utc_now_iso
from proven.scripts.etl_run import HAS_GNN_DEPS, convert_nx_to_pyg
...
class RuntimeCoverageMapper:
    ...
    def _persist_edges(self, edges):
        ...
        if HAS_GNN_DEPS:
            ...
            from proven.scripts.etl_run import build_node_mapping
