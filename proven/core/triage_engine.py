...
from proven.core.file_filters import is_source_code_file, is_valid_developer_name
...
class TriageEngine:
    ...
    def triage(self, bug_description: str, max_devs: int = 3, max_files: int = 5) -> Dict[str, Any]:
        ...
        try:
            ...
            import pandas as pd
            from proven.core.ai.predicter import Predictor
            from proven.core.ai.gnn_architecture import HGTLinkPrediction
